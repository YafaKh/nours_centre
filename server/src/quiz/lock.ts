 ...
 * options, correct answers, points, close date — is locked with no exceptions (PLAN.md
 * decision #5 / Phase 2 lock-rule test). Presence of a single Attempt row is authoritative.
 */
